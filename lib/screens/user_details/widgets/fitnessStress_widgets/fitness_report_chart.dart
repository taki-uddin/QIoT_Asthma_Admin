...
class FitnessReportChart extends StatefulWidget {
  ...
  @override
  State<FitnessReportChart> createState() =>
      _FitnessReportChartState();
}

class _FitnessReportChartState
    extends State<FitnessReportChart> {
